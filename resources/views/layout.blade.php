...
<head>
    ...
    <!--librerías adicionales-->
              ...
              <link href=" {{asset('js/calendar.js')}}" rel="stylesheet" />
              <link href=" {{asset('js/fullcalendar.js')}}" rel="stylesheet" />
              <link href=" {{asset('js/moment.min.js')}}" rel="stylesheet" />
              <link href="https://code.jquery.com/jquery-1.11.3.min.js" rel="stylesheet" />
              <!--FIN: fullcalendar-->

              <!--InputMask-->
              <link href=" {{asset('js/jquery.inputmask.bundle.js')}}" rel="stylesheet" />
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="dashboard"><i class="menu-icon fa fa-laptop"></i>Pantalla principal </a>
                    </li>
                    ...
                    <li class="menu-title">Opciones de Administrador</li><!-- /.menu-title -->
    ...
    <script src="{{asset('calendar/fullcalendar-init.js')}}"></script>
    ...
    <script>
      ...
      key = e.keyCode || e.which;
      tecla = String.fromCharCode(key).toLowerCase();
      letras = "1234567890abcdefghijklmnñopqrstuvwxyz-_~!$&'()*+,;=:@";
      especiales = "8-37-39-46";
      //--------------------------
      tecla_especial = false
      for(var i in especiales){
